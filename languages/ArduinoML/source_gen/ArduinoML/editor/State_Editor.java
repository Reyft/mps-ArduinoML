...
public class State_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_sjqidp_b2a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new State_Editor.transitionSingleRoleHandler_sjqidp_b2a(node, MetaAdapterFactory.getContainmentLink(0x3389428e8c9944b6L, 0x8b7e9adb09b40a0bL, 0x76e4e66065386d30L, 0x76e4e66065387979L, "transition"), editorContext);
